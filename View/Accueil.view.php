...
if (isset($this->error)) {
    ...
    <div class="container d-flex justify-content-between">
        ...
        <div class="card text-white bg-warning mb-3 d-flex justify-content-center" style="max-width: 20rem;margin: 8px -3px 11px -8px;">
            <div class="card-body">
                <h4 class="card-title " style="margin: -6px 10px 10px 56px;">Mathematiques</h4>
                <p class="card-text d-flex justify-content-center">
                    ...
                    tu développeras des compétences logiques, analytiques et de résolution de problèmes
                </p>
            </div>
        </div>
...
$titre = "Les livres de sciences représentent la connaissance";
